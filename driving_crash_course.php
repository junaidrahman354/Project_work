...
<!-- -------- -->
<div class="container-fluid page-header my-6 mt-0 wow fadeIn" data-wow-delay="0.1s">
    <div class="container text-center">
        <h1 class="display-4 text-white txt-sz animated slideInDown mb-4">Driving Crash Courses</h1>
