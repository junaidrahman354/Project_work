...
--
-- Host: localhost:3306
-- Generation Time: Dec 20, 2022 at 04:56 PM
...
(9, 'Automatic Car ', '280', '5', 'This PASS VERY FAST course is ideal for someone who has not been able to pass their test and would like to resit their test within just a few weeks gap in between tests.', '', 'Refresher course', '#ffff00'),
...
INSERT INTO `user_reviews` (`id`, `user_id`, `review`, `desc`) VALUES
(1, 5, 4, ''),
(2, 5, 4, ''),
(3, 5, 4, 'asdf'),
(4, 5, 4, ',asdm'),
