...
<?php 
    if(isset($_POST['btn'])){
      ...
      echo  $insert = "insert into `progress` (user_id, progress1, progress2, progress3, progress4, progress5, progress6, progress7, progress8, progress9, progress10, progress11, progress12, progress13, progress14, progress15, progress16, progress17, progress18, progress19, progress20, progress21, progress22, progress23, progress24, progress25, progress26, progress27, progress28, progress29, progress30, progress31, progress32, progress33, progress34, progress35, progress36, progress37, progress38, progress39, progress40, progress41, progress42, progress43, progress44, progress45, progress46, progress47, progress48, progress49, progress50, progress51, progress52) values ('$id', '$progress1', '$progress2', '$progress3', '$progress4', '$progress5', '$progress6', '$progress7', '$progress8', '$progress9', '$progress10', '$progress11', '$progress12', '$progress13', '$progress14', '$progress15', '$progress16', '$progress17', '$progress18', '$progress19', '$progress20', '$progress21', '$progress22', '$progress23', '$progress24', '$progress25', '$progress26', '$progress27', '$progress28', '$progress29', '$progress30', '$progress31', '$progress32', '$progress33', '$progress34', '$progress35', '$progress36', '$progress37', '$progress38', '$progress39', '$progress40', '$progress41', '$progress42', '$progress43', '$progress44', '$progress45', '$progress46', '$progress47', '$progress48', '$progress49', '$progress50', '$progress51', '$progress52')";
