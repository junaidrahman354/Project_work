...
<div class="row header">
                ...
                <div class="widget-content widget-content-area table_area br-6" style="overflow-x: scroll;">
...
?>
                            <tr>
                                ...
                                <th><?php echo $data2['subject34'] ?></th>
                                ...
                                <th><?php echo $data2['subject42'] ?></th>
...
?>
                                <tr>
                                    ...
                                    <td><?php echo $data['progress34'] ?></td>
                                    ...
                                    <td><?php echo $data['progress42'] ?></td>
                                    ...
                                    <td><a href="manage_progress.php?pid=<?php echo $data['id'] ?>&action=update" class="btn btn-primary">Update</a></td>
                                    <td><a href="manage_progress.php?id=<?php echo $data['id'] ?>&action=delete" class="btn btn-primary">Delete</a></td>
                                </tr>
<?php 
}
	$x++;
