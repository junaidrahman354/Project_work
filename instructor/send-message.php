...
?>
				<div class="form-group">
					<label>Name </label>
					<input type="text" name="name" class="form-control" placeholder="Enter User Name" value="<?php echo $data['first_name'] ?>" readonly="" required="">
				</div>
				<div class="form-group mt-3">
					<label> Email</label>
					<input type="email" name="email" class="form-control" placeholder="Enter User Emai " value="<?php echo $data['email'] ?>" readonly="" required="">
				</div>
				<div class="form-group mt-3">
					<label>Subject</label>
				...
				<div class="form-group mt-3">
					<label>Message</label>
					<textarea name="message" class="form-control" placeholder="Enter Subject" required=""></textarea>
				</div>
				<center><button type="submit" name="send" class="btn btn-dark btn-lg mt-3">Submit</button></center>
			</form>
		</div>
<?php 
    if(isset($_POST['send'])){
