		...
		<div class="col-lg-4 col-md-4 col-12 r-1">
				...
				<form method="POST">
					<div class="form-group">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject53'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject54'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject55'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject56'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject57'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject58'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject59'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject60'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject61'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject62'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject63'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject64'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject65'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject66'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject67'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject68'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject69'] ?>" class="form-control text-dark mt-5">
                            ...
                            <input type="text" readonly="" value="<?php echo $data['subject70'] ?>" class="form-control text-dark mt-5">
...
<?php 
    if(isset($_POST['btn'])){
        ...
        $update = "update `progress` set progress1 = '$progress1', progress2 = '$progress2', progress3 = '$progress3', progress4 = '$progress4', progress5 = '$progress5', progress6 = '$progress6', progress7 = '$progress7', progress8 = '$progress8', progress9 = '$progress9', progress10 = '$progress10', progress11 = '$progress11', progress12 = '$progress12', progress13 = '$progress13', progress14 = '$progress14', progress15 = '$progress15', progress16 = '$progress16', progress17 = '$progress17', progress18 = '$progress18', progress19 = '$progress19', progress20 = '$progress20', progress21 = '$progress21', progress22 = '$progress22', progress23 = '$progress23', progress24 = '$progress24', progress25 = '$progress25', progress26 = '$progress26', progress27 = '$progress27', progress28 = '$progress28', progress29 = '$progress29', progress30 = '$progress30', progress31 = '$progress31', progress32 = '$progress32', progress33 = '$progress33', progress34 = '$progress34', progress35 = '$progress35', progress36 = '$progress36', progress37 = '$progress37', progress38 = '$progress38', progress39 = '$progress39', progress40 = '$progress40', progress41 = '$progress41', progress42 = '$progress42', progress43 = '$progress43', progress44 = '$progress44', progress45 = '$progress45', progress46 = '$progress46', progress47 = '$progress47', progress48 = '$progress48', progress49 = '$progress49', progress50 = '$progress50', progress51 = '$progress51', progress52 = '$progress52', information = '$information' where id = '$pid'";
        $run = mysqli_query($con, $update);
        if(!$run){
            echo mysqli_error($con);
        }else{
