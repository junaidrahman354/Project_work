    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-12">
            ...
            <form method="post">
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="country" class="form-control" placeholder="Enter User Country">
                ...
                <div class="form-group mt-3">
                   ...
                   <input type="text" name="city" class="form-control" placeholder="Enter your city name" required="">
                   ...
                   <input type="text" name="post_code" class="form-control" placeholder="Enter your post Code" required="">
                ...
                <div class="form-group mt-3">
                    <label for="">Any other contact</label>

                    <input type="number" name="other_contact" class="form-control" placeholder="Enter your any other contact" id="">
                </div>

                <div class="form-group mt-3">
                    
                <label for="">ADI badge number</label>
             
               <input type="number" name="adi_badge_number" class="form-control" placeholder="Enter ADI badge number" id="">  
                </div>

                <div class="form-group mt-3">
                    <label  for="">Front picture of the ADI badge</label>
                    <input type="file" class="form-control" name="front_pic_badge" id="">
                </div>

                <div class="form-group mt-3">
                    <label  for="">Rear picture of the ADI badge</label>
                    <input type="file" class="form-control" name="rear_pic_badge" id="">
                </div>
                 <!-- ========= -->
                <div class="form-group mt-3">
                ...
                <center><button type="submit" name="register_btn" onClick='return confirm("Confirm to add this Instructer?")' class="btn btn-dark btn-lg mt-3">Submit</button></center>
        ...
        if (isset($_POST['register_btn'])) {
            ...
            if ($data['email'] == $email) {
                ...
                header("location:add_new_instructor.php");
            } else {

                $insert = "insert into instructor_registration(first_name, last_name, email, address, country, phone, password, email_code, email_status) value ('$first_name', '$last_name', '$email', '$address', '$country', '$phone', '$password', '$email_code', 'Pending')";
