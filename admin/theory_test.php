...
<div class="row header">
                <div class="widget-heading">
                    <h5 class="" style="color: black !important">Theory Test User</h5>
                </div>
                        ...
                        <tbody>
                               ...
                               ?>
                                <tr>
                                  ...
                                  <td><a href="theory_test.php?id=<?php echo $row['id'] ?>&action=delete" onClick='return confirm("Confirm to Delete?")' class="btn btn-primary">delete</a></td>
          ...
          if(isset($_GET['action'])){
            if($_GET['action'] == 'delete'){
                ...
                $delete = "delete from theory_test where id = '".$_GET['id']."'";
                ...
                if($run){
                    ...
                    header("location:theory_test.php");
                }
            }
          }
          ?>
