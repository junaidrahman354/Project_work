              ...
              $c=0;
				...
				<form method="POST">
					<div class="form-group">
                            ...
                            <textarea name="information" id="list" cols="5" rows="5" value="<?php echo $data1['information'] ?>"><?php echo $data1['information'] ?></textarea><br><br><br>
                            
                            <textarea name="admin_per_info" id="list" cols="5" rows="5" value="<?php echo $data1['admin_per_info'] ?>"><?php echo $data1['admin_per_info'] ?></textarea><br><br>
