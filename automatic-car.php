...
<div id="main_content">
<h1 class = "man-car">Automatic Car</h1>    
                        ...
                        <div class="course-icons__wrapper">
                            <ul class="course-icons course-icons--lg my-4">
                                <li class="course-icon Automatic" style="display:none;">
                                    ...
                                    <span class="course-icon__label">Automatic car</span>
                                </li>
...
<div  id="secondary_content"><h1 class = "man-car">Manual Car</h1><div class="container-xxl py-6">
    <div class="container">
        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
